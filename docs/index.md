...
# ![Conflux](assets/logo_light.png#only-light){ style="max-width: 500px; width: 90%;" }![Conflux](assets/logo_dark.png#only-dark){ style="max-width: 500px; width: 90%;" }
</div>

<span class="subtitle">Datacenter–Grid Coordination Simulation under LLM Workloads</span>
...
[Read the Paper](#){ .md-button .md-button--arxiv }
