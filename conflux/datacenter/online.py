...
[`InferencePowerAugmenter`][conflux.datacenter.workloads.inference.InferencePowerAugmenter]
pipeline.
...
from conflux.datacenter.base import LLMBatchSizeControlledDatacenter, LLMDatacenterState
...
from conflux.datacenter.workloads.inference import (
...
class VLLMDeployment(BaseModel):
    ...
    Pairs a reusable
    [`InferenceModelSpec`][conflux.datacenter.config.InferenceModelSpec]
...
class OnlineDatacenter(LLMBatchSizeControlledDatacenter[OnlineDatacenterState]):
    ...
    [`InferencePowerAugmenter`][conflux.datacenter.workloads.inference.InferencePowerAugmenter]
    pipeline (same as
    [`OfflineDatacenter`][conflux.datacenter.offline.OfflineDatacenter]).
