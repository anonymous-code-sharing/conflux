...
from conflux.datacenter.command import DatacenterCommand, SetBatchSize, ShiftReplicas
...
from conflux.datacenter.workloads.inference import InferenceData, InferencePowerAugmenter
...
class OfflineDatacenterState(LLMDatacenterState):
    ...
    [`LLMDatacenterState`][conflux.datacenter.base.LLMDatacenterState].
    """
...
class OfflineDatacenter(LLMBatchSizeControlledDatacenter[OfflineDatacenterState]):
    ...
    [`ServerPool`][conflux.datacenter.layout.ServerPool] with a random
