...
An [`EnergyStorage`][conflux.grid.storage.EnergyStorage] is a bidirectional,
...
class EnergyStorage(ABC):
    ...
    def set_power_kw(self, power_kw: float, reactive_power_kvar: float = 0.0) -> None:
        ...
        Subclasses with dispatch controlled by [`SetStoragePower`][conflux.grid.command.SetStoragePower]
