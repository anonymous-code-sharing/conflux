...
A [`Generator`][conflux.grid.generator.Generator] produces real power (kW)
as a function of time. Generators are attached to grid buses via
[`OpenDSSGrid.attach_generator`][conflux.grid.opendss.OpenDSSGrid.attach_generator].
...
from conflux.utils import smooth_bump
