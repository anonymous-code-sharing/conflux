...
from conflux.grid.command import GridCommand, SetStoragePower
from conflux.grid.opendss import OpenDSSGrid
from conflux.grid.storage import EnergyStorage
...
class LocalVoltageStorageDroopController(Controller[DatacenterBackend, OpenDSSGrid]):
    ...
    [`SetStoragePower`][conflux.grid.command.SetStoragePower] commands. In Q-V
    ...
    Args:
        grid: Grid backend.
        storages: Mapping from each [`EnergyStorage`][conflux.grid.storage.EnergyStorage]
